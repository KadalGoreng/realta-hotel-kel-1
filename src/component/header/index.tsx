          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-white hover:bg-[#B99982] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    <h1 className="text-white text-2xl relative">
                      Realta
                      <span className="flex-col "> Luxury Hotel</span>
                    </h1>
                  </div>
                </div>
              </div>
