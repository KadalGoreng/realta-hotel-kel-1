          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="/view/department" className="flex ml-2 md:mr-24">
                <img
                  ...
                  alt="FlowBite Logo"
                />
                <span className="text-white self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">
                  Realta Hotel
                </span>
              </a>
            </div>
            <div className="flex items-center">
              <div className="flex items-center ml-3">
                ...
                <div
                  className="z-50 hidden my-4 text-base list-none bg-dark divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                  id="dropdown-user"
                >
