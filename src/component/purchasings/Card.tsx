          ...
          <>
            <div className="carousel max-h-[200px] max-w-[150px]">
              <div id={`slide1${veproId}`} className="carousel-item relative w-full">
                <img
                  src={veproStock.stockPhotos[0] ? `http://localhost:3002/uploads/${findPrimary === undefined ? veproStock.stockPhotos[0].sphoThumbnailFilename : findPrimary.sphoPhotoFilename}` : "/static/images/defaultImage.png"}
                  // fallbackImage={"/static/images/defaultImage.png"}
                />

                {/* <img className="" src="/static/images/defaultImage.png"></img> */}
