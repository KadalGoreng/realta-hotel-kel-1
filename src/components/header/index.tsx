              ...
              <div className="flex h-16 items-center justify-between">
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                  <div className="flex flex-shrink-0 items-center">
                    <div className="block w-auto font-thin text-[22px] tracking-[0.3em] text-white lg:hidden">
                      REALTA HOTEL
                    </div>
                    <div className="hidden text-center leading-5 w-auto font-thin tracking-[0.3em] text-white lg:block">
                      <div className="text-[22px]">REALTA</div>
                      <div className="text-[10px]">LUXURY HOTEL</div>
                    </div>
                  </div>
                ...
                {!isLogged ? (
                  <div className="text-white tracking-[0.2em]">LOGIN</div>
                ) : (
