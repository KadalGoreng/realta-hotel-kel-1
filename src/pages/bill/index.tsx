...
import { orderMenusOneAkhirRequest } from "../../redux/Action/reduceActions";
...
export default function BillOrder() {
  ...
  return (
    <div>
              ...
              <div className="mt-[8px] flex justify-between">
                ...
                <div>
                  <p className="text-sm font-medium">
                    {value.orme_total_amount}
                  </p>
                </div>
              </div>

              <div>
                <p className=" text-center text-xs p-7">
                  Thanks you, Your order will be send to your room (Number room)
                </p>
              </div>
            </div>
          );
      ...
      <div className="flex justify-center">
        <a
          className=" print:hidden text-blue-700 underline text-sm font-thin mx-2"
