...
import { GetFacilityPhotoRequest, AddFacilityPhotoRequest, DelFacilityPhotoRequest } from "../../redux-saga/action/facilityPhotoAction";
import { useFormik, FormikProvider, Field } from "formik";
import DisplayImage from "./DisplayImage";
import PhotoPrimary from "./SetPhotoPrimary";
...
export default function AddPhoto(props: any) {
  ...
  useEffect(() => {
    dispatch(GetFacilityPhotoRequest(props.id));
    setRefresh(false);
                    ...
                    <div className="grid grid-cols-3 gap-10 my-5">
                      {(facilityPhotos || []).map((item: any) => (
                        <div key={item.faphoId}>
                          <DisplayImage imageSrc={`http://localhost:3002/facility-photos/image/${item.faphoPhotoFilename}`} fallbackImage={"/static/images/default.jpg"} />
