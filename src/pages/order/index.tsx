...
import {
  doCreateOrderMenus,
  doCreateOrderMenusDetail,
  doOrderMenusDetailRequest,
  doOrderMenusRequest,
  orderMenusIdAkhirRequest,
  orderMenusOneAkhirRequest,
...
export default function OrderMenu() {
  ...
  const totalQuantity = Keranjang.reduce(
    (total: number, item: any) => total + item.reme_quantity,
    0
  );
  ...
  let orderAKhirData = useSelector(
    (state: any) => state.orderMenusAkhirReducers.orderMenusAkhir
  );
  let IdAkhirOrderMenus1 = useSelector(
    (state: any) => state.orderMenusIdAkhirReducers.orderMenusIdAkhir
  );
          ...
          <div>
            ...
            <div className="card-cart mt-6 p-6 h-auto w-[750px] ">
              ...
              <div className="mt-3 flex items-center">
                ...
                <div className="ml-2 text-xs text-[#F33C5D] ">
              ...
              <div className="mt-6 flex gap-5">
                <div className="w-[350px]">
                  ...
                  <input
                    className="focus:shadow-outline w-full appearance-none rounded border py-2 px-3 leading-tight text-gray-500 "
                    id="fullname"
                    type="text"
                    value={userFullName}
                    disabled
            ...
            <div className="card-cart mt-4  w-[750px] p-8 ">
              ...
              <div className="mt-3 flex items-center">
                ...
                <div className="ml-3 text-xs text-[#F33C5D]">
                  please complate appropriate your data
                </div>
              </div>
              <div className="mt-6 flex gap-5">
                <div className="w-[350px]">
                  <label
                    htmlFor="pay-type"
                    className="mb-3 block text-sm font-semibold text-gray-600"
                  >
                    Payment Type
                  </label>
                  <select
                    ...
                    className="block w-full appearance-none rounded border py-2 px-3 leading-tight text-gray-500 focus:outline-gray-400 "
                  >
              ...
              <div className="w-full pt-6">
                ...
                <div className="pt-1">
                  <button
                    ...
                    className="h-10 w-full bg-[#F33C5D] text-white font-semibold rounded"
                  >
