...
import { GetFacilityPhotoRequest, AddFacilityPhotoRequest, DelFacilityPhotoRequest, GetManyFacilityPhotoRequest } from "../../redux-saga/action/facilityPhotoAction";
          ...
          <div className="relative w-auto my-6 mx-auto max-w-3xl max-h-96 overflow-y-scroll">
            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                <h3 className="text-3xl font-semibold">Facility Photos {props.id}</h3>
