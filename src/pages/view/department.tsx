...
import DepartmentCreate from "../form/departmentCreate";
import DepartmentUpdate from "../form/departmentUpdate";
...
export default function department() {
  ...
  const { department } = useSelector((state: any) => state.departmentState);
      ...
      <Layout>
        <>
          {displayEdit ? (
            ...
            <DepartmentCreate setRefresh={setRefresh} setDisplay={setDisplay} />
          ) : (
            <>
                            ...
                            <>
                              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td className="px-6 py-4">
                                  {item.deptModifiedDate}
                                </td>
                                <td className="px-6 py-4 text-right">
                                  <Dropdown label="..." inline={true}>
                                    <Dropdown.Item
                                      onClick={() => onClick(item.deptId)}
                                    >
                                      Edit
                                    </Dropdown.Item>
                                    <Dropdown.Item
                                      onClick={() => onDelete(item.deptId)}
                                    >
                                      Delete
                                    </Dropdown.Item>
                                  </Dropdown>
