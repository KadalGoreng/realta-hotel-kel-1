...
import WodeCreate from "../form/wodeCreate";
...
export default function Workdetail(props: any) {
  ...
  useEffect(() => {
    dispatch(GetWodeRequest(props.id));
  }, [refresh]);
                        ...
                        return (
                          <>
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                              <td className="px-6 py-4">{item.wode_wode_id}</td>
                              <td className="px-6 py-4">
                                {item.wode_wode_task_name}
                              </td>
                              <td className="px-6 py-4">
                                {item.wode_wode_notes}
                              </td>
                              <td className="px-6 py-4">
                                {item.wode_wode_status}
                              </td>
                              <td className="px-6 py-4">
                                {item.user_user_full_name}
                              </td>
