...
import PurchaseOrderHeaderApi from "@/api/purchasing/PurchaseOrderHeaderApi";
import {
...
} from "../../action/purchasing/purchaseOrderHeaderAction";

function* handlePurchaseOrderHeader(action: any): any {
  const { payload } = action;
  try {
    const result = yield call(PurchaseOrderHeaderApi.GetData, payload);
    console.log(result);
