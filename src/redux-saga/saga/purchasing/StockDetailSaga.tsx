...
import StockDetailApi from "@/api/purchasing/StockDetailApi";
...
import {
  ...
  GetStockDetailByStockIdSuccess,
  GetStockDetailFailed,
  GetStockDetailSuccess,
} from "../../action/purchasing/stockDetailAction";
...
function* StockDetailByStockId(action: any): any {
  ...
  try {
    const result = yield call(StockDetailApi.FindDataByStock, id, page);
    console.log(result);
    yield put(GetStockDetailByStockIdSuccess(result));
  } catch (error) {
