...
import ReduceMenusRestoService from "../Services/reduceService";
import {
...
function* handleOrderMenusIdAkhir(): any {
  try {
    const result: any = yield call(
      ReduceMenusRestoService.getIdAkhirOrderMenus
    );
...
function* handleAddOrderMenus(action: any): any {
  try {
    const result = yield call(
      ReduceMenusRestoService.createOrderMenus,
      action.payload
    );
...
function* handleAddOrderDetail(action: any): any {
  try {
    const result = yield call(
      ReduceMenusRestoService.createOrderDetail,
      action.payload
    );
...
function* handleCreatePhotoMenus(action: any): any {
  try {
    const result = yield call(
      ReduceMenusRestoService.createPhoto,
      action.payload
    );
    yield put(doPhotosRequestSucceed(result.data));
  } catch (error: any) {
...
function* handleUpdatePhotoMenus(): any {
  try {
    const result = yield call(
      ReduceMenusRestoService.updatePhotos.action.payload
    );
